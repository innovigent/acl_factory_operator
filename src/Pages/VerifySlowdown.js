...
const VerifyIssue = () => {
    ...
    const submit = async (e) => {
        ...
        try{
            ...
            const loginResponse = await axios.post("https://acl-automation.herokuapp.com/api/v1/slowruncontroller/verify",body,headers);
            history.push({pathname: '/SlowDownSpeed',
